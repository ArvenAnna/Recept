...
SELECT pg_catalog.setval('public.alternative_proportion_id_seq', 3, true);
...
766	Растопить масло	286	Соусы/Бешамель/Бешамель93ef3d82-5971-43a8-b319-39e78cc6f71f.jpg	1
767	Добавить муку, прогреть	286	Соусы/Бешамель/Бешамель117b1574-f19b-46e2-9be7-7a1bda58a6c3.jpg	2
768	Залить молоком, размешать.	286	Соусы/Бешамель/Бешамельb90a1703-f103-4d8b-9bde-1877b628b176.jpg	3
769	Варить до нужной густоты	286	Соусы/Бешамель/Бешамель60fd8f8e-186e-4f00-aa20-eabaaade8ae9.jpg	4
...
SELECT pg_catalog.setval('public.detail_ids', 887, true);
...
SELECT pg_catalog.setval('public.ingredient_ref_id_seq', 821, true);
...
SELECT pg_catalog.setval('public.ingridient_ids', 235, true);
...
SELECT pg_catalog.setval('public.proportion_ids', 2181, true);
...
SELECT pg_catalog.setval('public.recept_ids', 300, true);
...
Мясо нужно класть в кипящую воду, чтобы заварились поры и мясо было сочным. \nМясу нужно дать остыть в бульоне, в котором оно варилось.	Вареное мясо	10	300	Заготовки для рецептов/Вареное мясо/Вареное мясо7faf010f-36fb-4aec-9714-791d8db03182.jpg
	Болоньезе	8	171	Соусы/Болоньезе/Болоньезе5f9dbc2d-e0c4-4841-b242-4bb65510d7f6.JPG
Отварить стручковую фасоль или спаржу, поджаренный лук, залить взбитыми яйцами с бульоном (соком из-под фасоли) с приправами и солью.\r\n  Все выпечь при 230 град около 15 мин, посыпать зеленью.      	Replace me	2	42	Вторые блюда/Replace me/Фасоль запечённая в яйцах464a0d29-4be3-4b37-beb4-289d43232f08.png
...
SELECT pg_catalog.setval('public.reference_ids', 140, true);
