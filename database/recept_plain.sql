...
468	Начиненный перец	136	Вторые блюда/Фаршированный перец/Фаршированный перец90d7bb55-3ec1-45d0-9988-230e915f5e8c.png	1
...
SELECT pg_catalog.setval('public.detail_ids', 509, true);
...
SELECT pg_catalog.setval('public.ingredient_ref_id_seq', 392, true);
...
SELECT pg_catalog.setval('public.ingridient_ids', 179, true);
