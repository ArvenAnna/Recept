...
SELECT pg_catalog.setval('public.detail_ids', 195, true);
...
SELECT pg_catalog.setval('public.ingridient_ids', 157, true);
...
455	76	73	70г
456	76	95	4шт
457	76	96	(сушеная) 250г
469	78	27	3шт
470	78	82	0,5 ч.л.
448	76	1	(кипяток) 300мл
449	76	24	280г
450	76	35	
451	76	27	1шт
452	76	28	235г
453	76	25	0,75 стакана
458	77	33	1 стакан
459	77	27	2шт
460	77	25	1 стакан
461	77	82	1 ч.л.
...
SELECT pg_catalog.setval('public.proportion_ids', 1436, true);
...
Яблоки и клюкву залить кипятком, через 10 мин добавить в тесто.\nВыпекать  при 190 град 40 мин, полить топпингом (из молока, 1/4 стакана сахара, 75г масла и кокосовой стружки). Готовить ещё 20 мин.	Пирог дровосека	3	76	Десерты\\Пирог дровосека\\Pirog_drovoseka.png
...
Для приготовления теста сливочное масло и сметана должны быть холодными. Холодное масло я предварительно нарезала кубиком и еще подержала в морозилке 10 минут.\n\nВ миске соединить муку и соль. Добавить холодные кубики масла и быстро перетереть с мукой.\n\tДобавить холодную сметану и собрать тесто в шар. Тесто должно получиться мягким, не липнущим (если сразу тесто не собирается, липнет или наоборот рассыпается, то можно добавить 1 ст. л. муки или еще чуточку сметаны соответственно).\nШар теста, завернуть в пленку и отправить в холодильник минут на 30.\nПока тесто охлаждается, приготовим начинку.\nВ мисочке соединить творог, сахар и яйцо. Тщательно перетереть вилкой до однородного состояния.\nУ вишен удалить косточки. \nОхлажденное тесто тонко раскатать (я раскатывала сразу на листе пергамента для выпечки).\nВыложить творожную начинку, оставляя примерно 4-5 см края.\nСверху творожной начинки выложить вишенки. Края завернуть сверху на начинку. Края пирога и вишни чуть присыпать сахаром.\n\nАккуратно перенести лист пергамента с галетой на противень.\n\nВыпекать в разогретой до 200 градусов духовке 20-25 минут до золотистого цвета.	Галета с творогом	3	182	Десерты\\Галета с творогом\\IMG_3205.png
...
SELECT pg_catalog.setval('public.recept_ids', 185, true);
...
SELECT pg_catalog.setval('public.reference_ids', 30, true);
