...
SELECT pg_catalog.setval('public.detail_ids', 298, true);
...
SELECT pg_catalog.setval('public.ingridient_ids', 172, true);
...
SELECT pg_catalog.setval('public.proportion_ids', 1805, true);
...
SELECT pg_catalog.setval('public.recept_ids', 215, true);
...
SELECT pg_catalog.setval('public.reference_ids', 34, true);
