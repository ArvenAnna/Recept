...
SELECT pg_catalog.setval('public.detail_ids', 1021, true);
...
SELECT pg_catalog.setval('public.proportion_ids', 2259, true);
...
SELECT pg_catalog.setval('public.recept_ids', 313, true);
