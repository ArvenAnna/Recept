...
SELECT pg_catalog.setval('public.detail_ids', 293, true);
...
SELECT pg_catalog.setval('public.proportion_ids', 1790, true);
...
SELECT pg_catalog.setval('public.recept_ids', 213, true);
